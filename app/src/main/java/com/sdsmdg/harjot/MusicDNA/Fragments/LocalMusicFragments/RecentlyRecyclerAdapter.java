 ...
 */
public class RecentlyRecyclerAdapter extends RecyclerView.Adapter<RecentlyRecyclerAdapter.MyViewHolder> {

    List<Album> albumList;
    Context ctx;
    ImageLoader imgLoader;

    public RecentlyRecyclerAdapter(List<Album> albumList, Context ctx) {
